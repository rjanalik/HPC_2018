function [p1,p2] = hmetispart(A,xy,randseed)
% METISPART : Partition a graph using hMetis default method.
%
% p = hmetispart(A) returns a list of the vertices on one side of
...
[map, edgecut] = hmetismex('PartRecursive',A,2);
[p1,p2] = other(map);

if picture
    gplotpart(A,xy,p1);
    %gplotmap(A,xy,map);
    title('hMetis Partition')
end;